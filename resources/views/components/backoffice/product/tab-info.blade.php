                ...
                <form id="form-info-duration">
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-8 mt-3 mt-sm-0">
                            <x-input :model="$model" name="booking_deadline_minutes" type="number" label="Tempo limite prenotazione (minuti prima dell’inizio dell’orario di visita)" type="number" min="0" message="indica in minuti entro quando i clienti possono prenotare a ridosso dell'inizio del turno" icon="fa-regular fa-circle-info"/>
                        </div>
                    </div>
                </form>
                <div class="button-card-absolute">
